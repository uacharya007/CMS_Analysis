...
void data_dijet_imbalance_asymmetry_L2Residual(int infilInd=1) {
  ...
  TFile *outputFile = new TFile(Form("/afs/cern.ch/user/u/uacharya/eos/cms_analaysis/JEC_analysis/miniAOD_output/HiForestMiniAOD_JM1_v2_output_%d_4.root", infilInd), "RECREATE");
  //hrawPt_unCor->Write();
  //hrawPt->Write();
  for (int ipt = 0; ipt < nptBin; ipt++) {
   for (int ib = 0; ib < nEta; ib++) {
